...
public class SpawnPiece : MonoBehaviour
{
    ...
    public void Spawn()
    {
        ...
        if (Economy.instance.p1Energy >= piece.GetComponent<PlayablePieceV2>().cost)
            //This checks if the player can actually afford the piece, otherwise it doesn't spawn.
        {
